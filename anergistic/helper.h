...
void rbw_mark_range(u32 lo, u32 len);
extern u32 ls_taint[0x40000];      /* 0 = clean, else source LS offset + 1 */
extern u32 reg_taint[128][16];
extern int taint_on, taint_rt_set;
void taint_init(void);
void taint_ea_init(u32 ea_size);
void taint_dma_in(u32 lsa, u32 ea, u32 sz);
void taint_universal_init(void);
void taint_chan(int ch, int reg);
extern int taint_universal;
u32  taint_reg_any(u32 r);   /* returns origin offset+1, or 0 */
